      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            ...
            <br />
            I am constantly seeking opportunities to learn and attend important events such as RootedCON Malaga, UAD360,
            II and III Cybersecurity Congress of Andalusia, ARITH 2024 (where I was part of the staff), DES 2023 and 2024,
            YOLO Vision 2024, and several tech conferences on AI and cybersecurity across various cities in Spain.
            <br />
            <br />
